...
## Project Structure
    ...
    ├── testapiautostoryboa_64542  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_64542`
...
2. Clone this repo and `cd testapiautostoryboa_64542`
